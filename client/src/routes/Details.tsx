...
export default function Details() {
  ...
  const productDetail: any = useSelector(
    (state: any) => state.rootReducer.details
  );
  ...
  const StoreKeys: any =
    productDetail && productDetail.stock
      ? Object.keys(productDetail.stock)
      : [0];
      ...
      <div className={styles.gridLayout}>
        <div className={styles.col1}>
          <div className={styles.containerNavegacion}>
            ...
            <Link to={`/${productDetail.category}`} className={styles.link}>
              <span className={styles.Navegacion}>
                {" "}
            ...
            <Link
              to={`/${productDetail.category}/${productDetail.subCategory}`}
          ...
          <div className={styles.containerCuidados}>
            ...
            <p>
              {" "}
              {productDetail["product_care"]?.length < 50
                ? "Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium doloribus accusantium vel. Minus eum aperiam, ducimus maiores consequatur quod distinctio fugit sit libero suscipit, harum unde eveniet cumque, corporis maxime?"
                : productDetail["product_care"]}{" "}
            </p>
          </div>
        </div>
        ...
        <div className={styles.col2}>
          ...
          <form onSubmit={addToCart}>
            {productDetail.stock &&
            !(Object.entries(productDetail.stock).length === 0) ? (
            ...
            <div className={styles.contSucess}>
              {successful && (
                <span className={styles.sucessful}>{successful}</span>
              )}
            </div>
            <div className={styles.contErrors}>
              {errors.quantity && (
          ...
          <div className={styles.containerDescription}>
            ...
            <p>
              {productDetail.description?.length < 50
                ? "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Placeat dicta quae eos quaerat optio, asperiores similique tempora voluptatum reiciendis debitis expedita quam impedit id exercitationem ea accusamus nostrum nemo possimus."
