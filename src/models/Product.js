  ...
  sequelize.define(
    "product",
    {
      ...
      product_care: {
        type: DataTypes.STRING,
        validate: {
          is: { arg: /^\S/, msg: "The product care must not start with blank spaces" },
          is: { arg: /^[a-zA-Z0-9-_]*$/, msg: "The product care can only contain letters, numbers, hyphens and underscores" }
        },
      },
      image: {
        type: DataTypes.TEXT,
        ...
        validate: {
          is: { arg: /^\S/, msg: "The imgage link must not start with blank spaces" },
