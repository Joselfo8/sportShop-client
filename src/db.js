...
const { Stock, Product, User, Shopping_list, Favorite, Buy } = sequelize.models;
...
Buy.belongsToMany(Product, { through: "buy_product" });
Product.belongsToMany(Buy, { through: "buy_product" });
